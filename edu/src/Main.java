    ...
    public static void capitulo2(String nome) {
        ...
        switch (pergunta1) {
            ...
            case 2:
                ...
                System.out.println("Edgar: Você entendeu jovem?");
                System.out.println("\n" +
                        "1- Sim." +
                        "2- Não.");
                ...
                switch (pergunta3) {
                    case 1:
                        break;
                    case 2:
                        System.out.println("'Edgar: Bom, deixa eu te explicar novamente, em um polinómio há três termos: \n" +
                                "A = termos que acompanham x²\n" +
                                "B = Termos que acompanham x;\n" +
                                "C = Algarismos que não acompanham um valor de X.'");
                        break;
                ...
                break;
            case 3:
                System.out.println("Sim, porém não lembro.");
                System.out.println("'Edgar: Bom, deixa eu te explicar um pouco, em um polinómio há três termos: \n" +
                        "A = termos que acompanham x²\n" +
                        "B = Termos que acompanham x;\n" +
                        "C = Algarismos que não acompanham um valor de X.'");
